export type ProjectStatus = "live" | "in-dev" | "console";
...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    live: "",
    description:
      "An OOP-based ATM banking simulator built in Java. Features account creation, deposits, withdrawals, and transaction history. Runs in BlueJ / terminal.",
    tags: ["Java", "OOP", "BlueJ"],
